...
public class GooglePlayAPI {
    ...
    private static CryptProperties cryptProperties;
     ...
     */
    public GooglePlayAPI(CryptProperties cryptProperties, String email, String password, String androidID) {
        this(cryptProperties, email, password);
     ...
     */
    public GooglePlayAPI(CryptProperties cryptProperties, String email, String password) {
        this.setEmail(email);
        this.password = password;
        setClient(new DefaultHttpClient(getConnectionManager()));
        GooglePlayAPI.cryptProperties = cryptProperties;
    ...
    private static String encryptString(String str) {
        ...
        byte[] obj = new byte[5];
        Key createKeyFromString = createKeyFromString(cryptProperties.getKey(), obj);
    ...
    public void login() throws Exception {
         ...
         */
        Identity ident = Identity.signIn(cryptProperties, getClient(), getEmail(), password);
